...
<div  id="main" class="main">
    ...
    <table class="table table-bordered table-hover" cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
        ...
        <tr id="tr_id"  v-for="r in rows">
            ...
            <td>
                <button class="btn btn-success"  v-bind:value="r.id" onclick="confirmContract($(this).val())">确认合同</button>
            </td>
        </tr>
    </table>
    <div class="321">
...
<script>
    ...
    function  confirmContract(contractId) {
     vm.contractId = parseInt(contractId);
        if(role === "TENANT")
        {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/contract" + "/confirmContract",
                data: {
    ...
    {
        $.ajax({
            url: "${pageContext.request.contextPath}/contract" + "/getAllContractPageByTenantId",
    ...
    function getTotalSizeByPage() {
        $.ajax({
            url: "${pageContext.request.contextPath}/contract" + "/getContractTotalPageByTenantId",
            data: {pageNumber: vm.pageNumber, pageSize: vm.pageSize},
            type: "post",
            dataType: "json",
            success: function (data) {
    ...
    function getTotalPageByPage() {
        $.ajax({
            url: "${pageContext.request.contextPath}/contract" + "/getContractTotalElementsByTenantId",
            data: {pageNumber: vm.pageNumber, pageSize: vm.pageSize},
            type: "post",
            dataType: "json",
            success: function (data) {
